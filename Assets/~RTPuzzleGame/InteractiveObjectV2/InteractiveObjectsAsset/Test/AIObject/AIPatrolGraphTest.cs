...
namespace RTPuzzle
{
    ...
    {
        [WireCircleWorldAttribute(R = 0f, G = 1f, B = 0f, UseTransform = false, PositionFieldName = nameof(AIPatrolGraphTest.P1), Radius = 1f)] [WireArrowAttribute(SourceFieldName = nameof(AIPatrolGraphTest.P1), TargetFieldName = nameof(AIPatrolGraphTest.P3))] [MultiplePointMovementNested]
        public AIMoveToActionInputData P1;

        [WireCircleWorldAttribute(UseTransform = false, PositionFieldName = nameof(AIPatrolGraphTest.P2), Radius = 1f)] [WireArrowAttribute(SourceFieldName = nameof(AIPatrolGraphTest.P2), TargetFieldName = nameof(AIPatrolGraphTest.P1))] [MultiplePointMovementNested]
        public AIMoveToActionInputData P2;

        [WireCircleWorldAttribute(UseTransform = false, PositionFieldName = nameof(AIPatrolGraphTest.P3), Radius = 1f)] [WireArrowAttribute(SourceFieldName = nameof(AIPatrolGraphTest.P3), TargetFieldName = nameof(AIPatrolGraphTest.P2))] [MultiplePointMovementNested]
