...
public struct ObjectVariableStruct<T>
{
    private T Value;
    ...
    public ObjectVariableStruct(OnObjectValueChangedDelgate OnObjectValueChanged = null, Func<T, T, bool> Equality = null)
    {
        this.OnObjectValueChanged = OnObjectValueChanged;
        this.EqualityFunction = default;
        this.Value = default;
        if (Equality == null)
        {
            this.EqualityFunction = (v1, v2) => EqualityComparer<T>.Default.Equals(v1, v2);
